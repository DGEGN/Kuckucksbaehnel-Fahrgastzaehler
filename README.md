...
- **Start-Screen**: Fahrtag, Standort (Neustadt / Lambrecht) und verfügbare
  Sitzplätze im Zug werden einmal festgelegt. Öffnen mehrere Kassen denselben
  Fahrtag + Standort, zählen sie gemeinsam in dieselbe laufende Zahl.
- **Erwachsene** antippen → **+1**
- **Kinder** antippen → **+1**
...
fahrten/{fahrtId}/ereignisse/{eventId}   Live-Protokoll je Zählung
  kategorie: "erwachsene" | "kinder" | "familien" | "gruppen"
  anzahl: 1 | 4 | -1 | ...
  kasse: "Schalter 1"
  zeit: Timestamp
```
